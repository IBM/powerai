...
class DeploymentConfig(object):
  ...
  def variables_device(self, distribution_mod=None):
    ...
    def op_device_chooser(op):
      return op.device
 
    if distribution_mod is not None:
      return op_device_chooser
    elif not self._num_ps_tasks:
       return device
    else:
